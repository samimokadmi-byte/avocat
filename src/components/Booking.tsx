...
export default function Booking() {
  return (
    <section id="booking" className="bg-paper-2">
      <div className="px-8 py-16 md:py-section max-w-content mx-auto">

        {/* ── Section header ─────────────────────────────────────────── */}
        <div className="flex items-center gap-3 mb-10 md:mb-16">
          <span className="font-mono text-[11px] uppercase tracking-[0.08em] text-text2">[09]</span>
          <span className="w-8 h-px bg-hairline-strong flex-none" />
          <span className="font-mono text-[11px] uppercase tracking-[0.08em] text-text2">Diagnostic Stratégique</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            <p className="text-body text-text2 leading-relaxed mb-10">
            ...
            <ul className="flex flex-col gap-3 mb-10">
              {expertise.map(item => (
                <li key={item} className="flex items-center gap-3 text-body text-text2">
            ...
            <div className="flex flex-col gap-3">
              <span className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.06em] text-text2">
          ...
          <div className="flex flex-col justify-center">
            <div className="bg-paper border border-hairline-strong p-6 md:p-10">
              <p className="text-body text-text2 mb-8 leading-relaxed">
              ...
              <form className="flex flex-col gap-5" onSubmit={e => e.preventDefault()}>
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="border-b border-hairline-strong bg-transparent py-2.5 text-body text-ink placeholder:text-text2/40 focus:outline-none focus:border-accent transition-colors"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="font-mono text-[11px] uppercase tracking-[0.08em] text-text2">
                ...
                <button
                  type="submit"
                  className="mt-4 inline-flex items-center justify-center gap-3 bg-ink text-paper rounded-full px-[22px] py-[14px] text-sm font-medium hover:-translate-y-0.5 transition-all duration-200"
                >
                  Envoyer la demande
        ...
        {/* ── Footer strip ───────────────────────────────────────────── */}
        <div className="mt-section-sm -mx-8 px-8 border-t border-hairline pt-12 flex flex-col items-center gap-6">
          <Logo size={80} />
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 font-mono text-[11px] uppercase tracking-[0.06em] text-text2 text-center">
